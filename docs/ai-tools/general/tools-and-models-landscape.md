---
id: ai-general-tools-and-models-landscape
...
- [Claude Design — Anthropic Labs が提供するAIネイティブなデザイン環境](/docs/ai-tools/claude-code/claude-code-claude-design) - デザイン領域への AI エージェント拡張の最新事例
:::
